...
llama2_7b_f16qi4_stripped_source = fetch_source_fixture(
    "https://github.com/nod-ai/AMD-SHARK-Studio",
    group="llama2_7b_f16qi4_stripped",
)

llama2_7b_f16qi4_source = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2_7b_int4.mlir",
...
llama2_7b_f16qi4_first_input_cpu = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cpu/first_vicuna_forward_input.npy",
    group="llama2_7b_f16qi4_first_input_cpu",
)

llama2_7b_f16qi4_first_output_cpu = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cpu/first_vicuna_forward_output.npy",
    group="llama2_7b_f16qi4_first_output_cpu",
)

llama2_7b_f16qi4_second_input_cpu = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cpu/second_vicuna_forward_input.npy",
    group="llama2_7b_f16qi4_second_input_cpu",
)

llama2_7b_f16qi4_second_output_cpu = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cpu/second_vicuna_forward_output.npy",
...
llama2_7b_f16qi4_first_input_cuda = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cuda/first_vicuna_forward_input.npy",
    group="llama2_7b_f16qi4_first_input_cuda",
)

llama2_7b_f16qi4_first_output_cuda = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cuda/first_vicuna_forward_output.npy",
    group="llama2_7b_f16qi4_first_output_cuda",
)

llama2_7b_f16qi4_second_input_cuda = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cuda/second_vicuna_forward_input.npy",
    group="llama2_7b_f16qi4_second_input_cuda",
)

llama2_7b_f16qi4_second_output_cuda = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/llama_regression/llama2-7b-i4-golden-outputs/cuda/second_vicuna_forward_output.npy",
