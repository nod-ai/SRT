...
argmax_ukernel_source = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/ukernel_regression/20231217/argmax/argmax_3d_linalg.mlir",
...
argmax_input_f16 = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/ukernel_regression/20231217/argmax/argmax_3d_input_f16.npy",
    group="argmax_ukernel_input_f16",
)

argmax_output_f16 = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/ukernel_regression/20231217/argmax/argmax_3d_output_f16.npy",
    group="argmax_ukernel_output_f16",
)

argmax_input_f32 = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/ukernel_regression/20231217/argmax/argmax_3d_input_f32.npy",
    group="argmax_ukernel_input_f32",
)

argmax_output_f32 = fetch_source_fixture(
    "https://storage.googleapis.com/amd_shark_tank/ukernel_regression/20231217/argmax/argmax_3d_output_f32.npy",
